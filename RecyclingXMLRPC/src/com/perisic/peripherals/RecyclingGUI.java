...
public class RecyclingGUI extends JFrame {
	...
	public RecyclingGUI() {
		...
		ImageIcon bottle = new ImageIcon("D:\\Users\\Ash\\eclipse-workspace\\RECYCLEPLS\\src\\plastic bottle.png");
		ImageIcon can = new ImageIcon("D:\\Users\\Ash\\eclipse-workspace\\RECYCLEPLS\\src\\can.png");
		ImageIcon crate = new ImageIcon("D:\\Users\\Ash\\eclipse-workspace\\RECYCLEPLS\\src\\crate.png");
		ImageIcon paperbag = new ImageIcon("D:\\Users\\Ash\\eclipse-workspace\\RECYCLEPLS\\src\\paperbag.png");
		ImageIcon receipts = new ImageIcon("D:\\Users\\Ash\\eclipse-workspace\\RECYCLEPLS\\src\\receipt.png");
		
		
		
		JButton slot1 = new InsertItemButton("Can", can, myPanel, 1);
		...
		JButton slot2 = new InsertItemButton("Bottle", bottle, myPanel, 2); 
		...
		JButton slot3 = new InsertItemButton("Crate", crate, myPanel, 3);
		...
		JButton slot4 = new InsertItemButton("Paper Bag", paperbag, myPanel, 4);
		...
		JButton receipt = new JButton("Receipt", receipts);
